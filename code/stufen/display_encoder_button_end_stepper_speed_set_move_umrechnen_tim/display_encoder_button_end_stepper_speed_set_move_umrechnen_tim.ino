      ...
      if (hpos == 1) {                                    //home dir motor site
        ...
        while (turn == 0) {
          ...
          if (end1 == HIGH) {
            ...
            tft.setTextColor(ST7735_WHITE);
            tft.setCursor(20, 60);
            tft.print(lengh / (speeds * circumference));
            tft.setCursor(60, 60);
            tft.print("min");
      ...
      if (hpos == 0) {                                      //home dir inputpanel site
        ...
        while (turn == 0) {
          ...
          if (end2 == HIGH) {
            ...
            tft.setTextColor(ST7735_GREEN);
            tft.setCursor(20, 20);
            tft.print("turn nob to set time");
            tft.setTextColor(ST7735_WHITE);
            tft.setCursor(20, 60);
            tft.print(lengh / (speeds * circumference));
            tft.setCursor(60, 60);
      ...
      while (insetspeed == 0) {
        ...
        if (hpos == 0) {                    //move towared opposite end like homed
          ...
          while (turn == 0) {
            ...
            if (end1 == HIGH) {                             //if reached end wait, if encoder btn pressed go back ^speed
        ...
        if (hpos == 1) {                     //move towared oppsoite end like homed
