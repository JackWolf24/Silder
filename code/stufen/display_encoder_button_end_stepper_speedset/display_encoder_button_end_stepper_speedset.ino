...
void loop() {
    ...
    if (!digitalRead(btn) == HIGH) {
      ...
      if (hpos == 1) {
        ...
        while (turn == 0) {
          ...
          tft.fillScreen(ST7735_BLACK);
          tft.setCursor(20, 40);
          tft.print("turning towards motor side...");
      ...
      if (hpos == 0) {
        ...
        while (turn == 0) {
          ...
          tft.fillScreen(ST7735_BLACK);
          tft.setCursor(20, 40);
          tft.print("turning towards inputpanel side...");
  ...
  if (neuePosition > altePosition) {
    speeds = speeds + 1;
    tft.fillRect(20, 50, 10, 30, ST7735_BLACK);
    tft.setCursor(20, 50);
    tft.print(speeds, "rpm");
